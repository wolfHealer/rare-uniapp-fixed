...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.2.5";
  const port = "8090";
  const id = "mp-weixin_Bbf3-d";
...
function setConfig$1(configs) {
  ...
  shallowMerge(props$t, configs.props || {});
...
function setConfig(configs) {
  ...
  index.shallowMerge(props$t, configs.props || {});
...
const props$s = defineMixin({
  props: {
    ...
    name: {
      type: String,
      default: () => props$t.icon.name
    },
    // 图标颜色，可接受主题色
    color: {
      type: String,
      default: () => props$t.icon.color
    },
    // 字体大小，单位px
    size: {
      type: [String, Number],
      default: () => props$t.icon.size
    },
    // 是否显示粗体
    bold: {
      type: Boolean,
      default: () => props$t.icon.bold
    },
    // 点击图标的时候传递事件出去的index（用于区分点击了哪一个）
    index: {
      type: [String, Number],
      default: () => props$t.icon.index
    },
    // 触摸图标时的类名
    hoverClass: {
      type: String,
      default: () => props$t.icon.hoverClass
    },
    // 自定义扩展前缀，方便用户扩展自己的图标库
    customPrefix: {
      type: String,
      default: () => props$t.icon.customPrefix
    },
    // 图标右边或者下面的文字
    label: {
      type: [String, Number],
      default: () => props$t.icon.label
    },
    // label的位置，只能右边或者下边
    labelPos: {
      type: String,
      default: () => props$t.icon.labelPos
    },
    // label的大小
    labelSize: {
      type: [String, Number],
      default: () => props$t.icon.labelSize
    },
    // label的颜色
    labelColor: {
      type: String,
      default: () => props$t.icon.labelColor
    },
    // label与图标的距离
    space: {
      type: [String, Number],
      default: () => props$t.icon.space
    },
    // 图片的mode
    imgMode: {
      type: String,
      default: () => props$t.icon.imgMode
    },
    // 用于显示图片小图标时，图片的宽度
    width: {
      type: [String, Number],
      default: () => props$t.icon.width
    },
    // 用于显示图片小图标时，图片的高度
    height: {
      type: [String, Number],
      default: () => props$t.icon.height
    },
    // 用于解决某些情况下，让图标垂直居中的用途
    top: {
      type: [String, Number],
      default: () => props$t.icon.top
    },
    // 是否阻止事件传播
    stop: {
      type: Boolean,
      default: () => props$t.icon.stop
    }
  }
});
const props$r = defineMixin({
  props: {
    ...
    isDot: {
      type: Boolean,
      default: () => props$t.badge.isDot
    },
    // 显示的内容
    value: {
      type: [Number, String],
      default: () => props$t.badge.value
    },
    // 显示的内容
    modelValue: {
      type: [Number, String],
      default: () => props$t.badge.modelValue
    },
    // 是否显示
    show: {
      type: Boolean,
      default: () => props$t.badge.show
    },
    // 最大值，超过最大值会显示 '{max}+'
    max: {
      type: [Number, String],
      default: () => props$t.badge.max
    },
    // 主题类型，error|warning|success|primary
    type: {
      type: String,
      default: () => props$t.badge.type
    },
    // 当数值为 0 时，是否展示 Badge
    showZero: {
      type: Boolean,
      default: () => props$t.badge.showZero
    },
    // 背景颜色，优先级比type高，如设置，type参数会失效
    bgColor: {
      type: [String, null],
      default: () => props$t.badge.bgColor
    },
    // 字体颜色
    color: {
      type: [String, null],
      default: () => props$t.badge.color
    },
    // 徽标形状，circle-四角均为圆角，horn-左下角为直角
    shape: {
      type: String,
      default: () => props$t.badge.shape
    },
    ...
    numberType: {
      type: String,
      default: () => props$t.badge.numberType
    },
    // 设置badge的位置偏移，格式为 [x, y]，也即设置的为top和right的值，absolute为true时有效
    offset: {
      type: Array,
      default: () => props$t.badge.offset
    },
    // 是否反转背景和字体颜色
    inverted: {
      type: Boolean,
      default: () => props$t.badge.inverted
    },
    // 是否绝对定位
    absolute: {
      type: Boolean,
      default: () => props$t.badge.absolute
    }
  }
});
const props$q = defineMixin({
  props: {
    ...
    list: {
      type: Array,
      default: () => props$t.swiper.list
    },
    // 是否显示面板指示器
    indicator: {
      type: Boolean,
      default: () => props$t.swiper.indicator
    },
    // 指示器非激活颜色
    indicatorActiveColor: {
      type: String,
      default: () => props$t.swiper.indicatorActiveColor
    },
    // 指示器的激活颜色
    indicatorInactiveColor: {
      type: String,
      default: () => props$t.swiper.indicatorInactiveColor
    },
    // 指示器样式，可通过bottom，left，right进行定位
    indicatorStyle: {
      type: [String, Object],
      default: () => props$t.swiper.indicatorStyle
    },
    // 指示器模式，line-线型，dot-点型
    indicatorMode: {
      type: String,
      default: () => props$t.swiper.indicatorMode
    },
    // 是否自动切换
    autoplay: {
      type: Boolean,
      default: () => props$t.swiper.autoplay
    },
    // 当前所在滑块的 index
    current: {
      type: [String, Number],
      default: () => props$t.swiper.current
    },
    // 当前所在滑块的 item-id ，不能与 current 被同时指定
    currentItemId: {
      type: String,
      default: () => props$t.swiper.currentItemId
    },
    // 滑块自动切换时间间隔
    interval: {
      type: [String, Number],
      default: () => props$t.swiper.interval
    },
    // 滑块切换过程所需时间
    duration: {
      type: [String, Number],
      default: () => props$t.swiper.duration
    },
    // 播放到末尾后是否重新回到开头
    circular: {
      type: Boolean,
      default: () => props$t.swiper.circular
    },
    // 前边距，可用于露出前一项的一小部分，nvue和支付宝不支持
    previousMargin: {
      type: [String, Number],
      default: () => props$t.swiper.previousMargin
    },
    // 后边距，可用于露出后一项的一小部分，nvue和支付宝不支持
    nextMargin: {
      type: [String, Number],
      default: () => props$t.swiper.nextMargin
    },
    // 当开启时，会根据滑动速度，连续滑动多屏，支付宝不支持
    acceleration: {
      type: Boolean,
      default: () => props$t.swiper.acceleration
    },
    // 同时显示的滑块数量，nvue、支付宝小程序不支持
    displayMultipleItems: {
      type: Number,
      default: () => props$t.swiper.displayMultipleItems
    },
    // 指定swiper切换缓动动画类型，有效值：default、linear、easeInCubic、easeOutCubic、easeInOutCubic
    // 只对微信小程序有效
    easingFunction: {
      type: String,
      default: () => props$t.swiper.easingFunction
    },
    // list数组中指定对象的目标属性名
    keyName: {
      type: String,
      default: () => props$t.swiper.keyName
    },
    // 图片的裁剪模式
    imgMode: {
      type: String,
      default: () => props$t.swiper.imgMode
    },
    // 组件高度
    height: {
      type: [String, Number],
      default: () => props$t.swiper.height
    },
    // 背景颜色
    bgColor: {
      type: String,
      default: () => props$t.swiper.bgColor
    },
    // 组件圆角，数值或带单位的字符串
    radius: {
      type: [String, Number],
      default: () => props$t.swiper.radius
    },
    // 是否加载中
    loading: {
      type: Boolean,
      default: () => props$t.swiper.loading
    },
    // 是否显示标题，要求数组对象中有title属性
    showTitle: {
      type: Boolean,
      default: () => props$t.swiper.showTitle
    }
  }
});
const props$p = defineMixin({
  props: {
    ...
    type: {
      type: String,
      default: () => props$t.tag.type
    },
    // 不可用
    disabled: {
      type: [Boolean, String],
      default: () => props$t.tag.disabled
    },
    // 标签的大小，large，medium，mini
    size: {
      type: String,
      default: () => props$t.tag.size
    },
    // tag的形状，circle（两边半圆形）, square（方形，带圆角）
    shape: {
      type: String,
      default: () => props$t.tag.shape
    },
    // 标签文字
    text: {
      type: [String, Number],
      default: () => props$t.tag.text
    },
    // 背景颜色，默认为空字符串，即不处理
    bgColor: {
      type: String,
      default: () => props$t.tag.bgColor
    },
    // 标签字体颜色，默认为空字符串，即不处理
    color: {
      type: String,
      default: () => props$t.tag.color
    },
    // 标签的边框颜色
    borderColor: {
      type: String,
      default: () => props$t.tag.borderColor
    },
    // 关闭按钮图标的颜色
    closeColor: {
      type: String,
      default: () => props$t.tag.closeColor
    },
    // 点击时返回的索引值，用于区分例遍的数组哪个元素被点击了
    name: {
      type: [String, Number],
      default: () => props$t.tag.name
    },
    ...
    plainFill: {
      type: Boolean,
      default: () => props$t.tag.plainFill
    },
    // 是否镂空
    plain: {
      type: Boolean,
      default: () => props$t.tag.plain
    },
    // 是否可关闭
    closable: {
      type: Boolean,
      default: () => props$t.tag.closable
    },
    // 是否显示
    show: {
      type: Boolean,
      default: () => props$t.tag.show
    },
    // 内置图标，或绝对路径的图片
    icon: {
      type: String,
      default: () => props$t.tag.icon
    },
    // 图标颜色
    iconColor: {
      type: String,
      default: () => props$t.tag.iconColor
    },
    // 自定义尺寸字体大小
    textSize: {
      type: String,
      default: () => props$t.tag.textSize
    },
    // 自定义尺寸高度
    height: {
      type: String,
      default: () => props$t.tag.height
    },
    // 自定义尺寸padding
    padding: {
      type: String,
      default: () => props$t.tag.padding
    },
    // 自定义尺寸
    borderRadius: {
      type: String,
      default: () => props$t.tag.borderRadius
    },
    // 自动计算背景色
    autoBgColor: {
      type: Number,
      default: () => props$t.tag.autoBgColor
    }
  }
});
const props$o = defineMixin({
  props: {
    ...
    src: {
      type: String,
      default: () => props$t.image.src
    },
    // 裁剪模式
    mode: {
      type: String,
      default: () => props$t.image.mode
    },
    // 宽度，单位任意
    width: {
      type: [String, Number],
      default: () => props$t.image.width
    },
    // 高度，单位任意
    height: {
      type: [String, Number],
      default: () => props$t.image.height
    },
    // 图片形状，circle-圆形，square-方形
    shape: {
      type: String,
      default: () => props$t.image.shape
    },
    // 圆角，单位任意
    radius: {
      type: [String, Number],
      default: () => props$t.image.radius
    },
    // 是否懒加载，微信小程序、App、百度小程序、字节跳动小程序
    lazyLoad: {
      type: Boolean,
      default: () => props$t.image.lazyLoad
    },
    // 开启长按图片显示识别微信小程序码菜单
    showMenuByLongpress: {
      type: Boolean,
      default: () => props$t.image.showMenuByLongpress
    },
    // 加载中的图标，或者小图片
    loadingIcon: {
      type: String,
      default: () => props$t.image.loadingIcon
    },
    // 加载失败的图标，或者小图片
    errorIcon: {
      type: String,
      default: () => props$t.image.errorIcon
    },
    // 是否显示加载中的图标或者自定义的slot
    showLoading: {
      type: Boolean,
      default: () => props$t.image.showLoading
    },
    // 是否显示加载错误的图标或者自定义的slot
    showError: {
      type: Boolean,
      default: () => props$t.image.showError
    },
    // 是否需要淡入效果
    fade: {
      type: Boolean,
      default: () => props$t.image.fade
    },
    // 只支持网络资源，只对微信小程序有效
    webp: {
      type: Boolean,
      default: () => props$t.image.webp
    },
    // 过渡时间，单位ms
    duration: {
      type: [String, Number],
      default: () => props$t.image.duration
    },
    // 背景颜色，用于深色页面加载图片时，为了和背景色融合
    bgColor: {
      type: String,
      default: () => props$t.image.bgColor
    }
  }
});
const props$n = defineMixin({
  props: {
    ...
    title: {
      type: [String, Number],
      default: () => props$t.cell.title
    },
    // 标题下方的描述信息
    label: {
      type: [String, Number],
      default: () => props$t.cell.label
    },
    // 右侧的内容
    value: {
      type: [String, Number],
      default: () => props$t.cell.value
    },
    // 左侧图标名称，或者图片链接(本地文件建议使用绝对地址)
    icon: {
      type: String,
      default: () => props$t.cell.icon
    },
    // 是否禁用cell
    disabled: {
      type: Boolean,
      default: () => props$t.cell.disabled
    },
    // 是否显示下边框
    border: {
      type: Boolean,
      default: () => props$t.cell.border
    },
    // 内容是否垂直居中(主要是针对右侧的value部分)
    center: {
      type: Boolean,
      default: () => props$t.cell.center
    },
    // 点击后跳转的URL地址
    url: {
      type: String,
      default: () => props$t.cell.url
    },
    // 链接跳转的方式，内部使用的是uView封装的route方法，可能会进行拦截操作
    linkType: {
      type: String,
      default: () => props$t.cell.linkType
    },
    // 是否开启点击反馈(表现为点击时加上灰色背景)
    clickable: {
      type: Boolean,
      default: () => props$t.cell.clickable
    },
    // 是否展示右侧箭头并开启点击反馈
    isLink: {
      type: Boolean,
      default: () => props$t.cell.isLink
    },
    // 是否显示表单状态下的必填星号(此组件可能会内嵌入input组件)
    required: {
      type: Boolean,
      default: () => props$t.cell.required
    },
    // 右侧的图标箭头
    rightIcon: {
      type: String,
      default: () => props$t.cell.rightIcon
    },
    // 右侧箭头的方向，可选值为：left，up，down
    arrowDirection: {
      type: String,
      default: () => props$t.cell.arrowDirection
    },
    // 左侧图标样式
    iconStyle: {
      type: [Object, String],
      default: () => {
        return props$t.cell.iconStyle;
      }
    },
    // 右侧箭头图标的样式
    rightIconStyle: {
      type: [Object, String],
      default: () => {
        return props$t.cell.rightIconStyle;
      }
    },
    // 标题的样式
    titleStyle: {
      type: [Object, String],
      default: () => {
        return props$t.cell.titleStyle;
      }
    },
    // 单位元的大小，可选值为large
    size: {
      type: String,
      default: () => props$t.cell.size
    },
    // 点击cell是否阻止事件传播
    stop: {
      type: Boolean,
      default: () => props$t.cell.stop
    },
    // 标识符，cell被点击时返回
    name: {
      type: [Number, String],
      default: () => props$t.cell.name
    }
  }
});
const props$m = defineMixin({
  props: {
    ...
    title: {
      type: String,
      default: () => props$t.cellGroup.title
    },
    // 是否显示外边框
    border: {
      type: Boolean,
      default: () => props$t.cellGroup.border
    }
  }
});
const props$l = defineMixin({
  props: {
    ...
    safeAreaInsetTop: {
      type: Boolean,
      default: () => props$t.navbar.safeAreaInsetTop
    },
    // 固定在顶部时，是否生成一个等高元素，以防止塌陷
    placeholder: {
      type: Boolean,
      default: () => props$t.navbar.placeholder
    },
    // 是否固定在顶部
    fixed: {
      type: Boolean,
      default: () => props$t.navbar.fixed
    },
    // 是否显示下边框
    border: {
      type: Boolean,
      default: () => props$t.navbar.border
    },
    // 左边的图标
    leftIcon: {
      type: String,
      default: () => props$t.navbar.leftIcon
    },
    // 左边的提示文字
    leftText: {
      type: String,
      default: () => props$t.navbar.leftText
    },
    // 左右的提示文字
    rightText: {
      type: String,
      default: () => props$t.navbar.rightText
    },
    // 右边的图标
    rightIcon: {
      type: String,
      default: () => props$t.navbar.rightIcon
    },
    // 标题
    title: {
      type: [String, Number],
      default: () => props$t.navbar.title
    },
    // 标题颜色
    titleColor: {
      type: String,
      default: () => props$t.navbar.titleColor
    },
    // 背景颜色
    bgColor: {
      type: String,
      default: () => props$t.navbar.bgColor
    },
    ...
    titleWidth: {
      type: [String, Number],
      default: () => props$t.navbar.titleWidth
    },
    // 导航栏高度
    height: {
      type: [String, Number],
      default: () => props$t.navbar.height
    },
    // 左侧返回图标的大小
    leftIconSize: {
      type: [String, Number],
      default: () => props$t.navbar.leftIconSize
    },
    // 左侧返回图标的颜色
    leftIconColor: {
      type: String,
      default: () => props$t.navbar.leftIconColor
    },
    // 点击左侧区域(返回图标)，是否自动返回上一页
    autoBack: {
      type: Boolean,
      default: () => props$t.navbar.autoBack
    },
    // 标题的样式，对象或字符串
    titleStyle: {
      type: [String, Object],
      default: () => props$t.navbar.titleStyle
    }
  }
});
...
const props$k = defineMixin({
  props: {
    ...
    hairline: {
      type: Boolean,
      default: () => props$t.button.hairline
    },
    // 按钮的预置样式，info，primary，error，warning，success
    type: {
      type: String,
      default: () => props$t.button.type
    },
    // 按钮尺寸，large，normal，small，mini
    size: {
      type: String,
      default: () => props$t.button.size
    },
    // 按钮形状，circle（两边为半圆），square（带圆角）
    shape: {
      type: String,
      default: () => props$t.button.shape
    },
    // 按钮是否镂空
    plain: {
      type: Boolean,
      default: () => props$t.button.plain
    },
    // 是否禁止状态
    disabled: {
      type: Boolean,
      default: () => props$t.button.disabled
    },
    // 是否加载中
    loading: {
      type: Boolean,
      default: () => props$t.button.loading
    },
    // 加载中提示文字
    loadingText: {
      type: [String, Number],
      default: () => props$t.button.loadingText
    },
    // 加载状态图标类型
    loadingMode: {
      type: String,
      default: () => props$t.button.loadingMode
    },
    // 加载图标大小
    loadingSize: {
      type: [String, Number],
      default: () => props$t.button.loadingSize
    },
    // 开放能力，具体请看uniapp稳定关于button组件部分说明
    // https://uniapp.dcloud.io/component/button
    openType: {
      type: String,
      default: () => props$t.button.openType
    },
    // 用于 <form> 组件，点击分别会触发 <form> 组件的 submit/reset 事件
    // 取值为submit（提交表单），reset（重置表单）
    formType: {
      type: String,
      default: () => props$t.button.formType
    },
    // 打开 APP 时，向 APP 传递的参数，open-type=launchApp时有效
    // 只微信小程序、QQ小程序有效
    appParameter: {
      type: String,
      default: () => props$t.button.appParameter
    },
    // 指定是否阻止本节点的祖先节点出现点击态，微信小程序有效
    hoverStopPropagation: {
      type: Boolean,
      default: () => props$t.button.hoverStopPropagation
    },
    // 指定返回用户信息的语言，zh_CN 简体中文，zh_TW 繁体中文，en 英文。只微信小程序有效
    lang: {
      type: String,
      default: () => props$t.button.lang
    },
    // 会话来源，open-type="contact"时有效。只微信小程序有效
    sessionFrom: {
      type: String,
      default: () => props$t.button.sessionFrom
    },
    // 会话内消息卡片标题，open-type="contact"时有效
    // 默认当前标题，只微信小程序有效
    sendMessageTitle: {
      type: String,
      default: () => props$t.button.sendMessageTitle
    },
    // 会话内消息卡片点击跳转小程序路径，open-type="contact"时有效
    // 默认当前分享路径，只微信小程序有效
    sendMessagePath: {
      type: String,
      default: () => props$t.button.sendMessagePath
    },
    // 会话内消息卡片图片，open-type="contact"时有效
    // 默认当前页面截图，只微信小程序有效
    sendMessageImg: {
      type: String,
      default: () => props$t.button.sendMessageImg
    },
    // 是否显示会话内消息卡片，设置此参数为 true，用户进入客服会话会在右下角显示"可能要发送的小程序"提示，
    // 用户点击后可以快速发送小程序消息，open-type="contact"时有效
    showMessageCard: {
      type: Boolean,
      default: () => props$t.button.showMessageCard
    },
    // 额外传参参数，用于小程序的data-xxx属性，通过target.dataset.name获取
    dataName: {
      type: String,
      default: () => props$t.button.dataName
    },
    // 节流，一定时间内只能触发一次
    throttleTime: {
      type: [String, Number],
      default: () => props$t.button.throttleTime
    },
    // 按住后多久出现点击态，单位毫秒
    hoverStartTime: {
      type: [String, Number],
      default: () => props$t.button.hoverStartTime
    },
    // 手指松开后点击态保留时间，单位毫秒
    hoverStayTime: {
      type: [String, Number],
      default: () => props$t.button.hoverStayTime
    },
    // 按钮文字，之所以通过props传入，是因为slot传入的话
    // nvue中无法控制文字的样式
    text: {
      type: [String, Number],
      default: () => props$t.button.text
    },
    // 按钮图标
    icon: {
      type: String,
      default: () => props$t.button.icon
    },
    // 按钮图标
    iconColor: {
      type: String,
    ...
    color: {
      type: String,
      default: () => props$t.button.color
    },
    // 停止冒泡
    stop: {
      type: Boolean,
      default: () => props$t.button.stop
    }
  }
});
const props$j = defineMixin({
  props: {
    ...
    modelValue: {
      type: [String, Number],
      default: () => props$t.search.value
    },
    // 搜索框形状，round-圆形，square-方形
    shape: {
      type: String,
      default: () => props$t.search.shape
    },
    // 搜索框背景色
    bgColor: {
      type: String,
      default: () => props$t.search.bgColor
    },
    // 占位提示文字
    placeholder: {
      type: String,
      default: () => props$t.search.placeholder
    },
    // 是否启用清除控件
    clearabled: {
      type: Boolean,
      default: () => props$t.search.clearabled
    },
    // 是否仅聚焦时显示清除控件
    ...
    focus: {
      type: Boolean,
      default: () => props$t.search.focus
    },
    // 是否在搜索框右侧显示取消按钮
    showAction: {
      type: Boolean,
      default: () => props$t.search.showAction
    },
    // 右侧取消按钮文字
    actionText: {
      type: String,
      default: () => props$t.search.actionText
    },
    // 搜索框左侧文本
    label: {
      type: [String, Number, null],
      default: () => props$t.search.label
    },
    // 输入框内容对齐方式，可选值为：left|center|right
    inputAlign: {
      type: String,
      default: () => props$t.search.inputAlign
    },
    // 是否启用输入框
    disabled: {
      type: Boolean,
      default: () => props$t.search.disabled
    },
    // 开启showAction时，是否在input获取焦点时才显示
    animation: {
      type: Boolean,
      default: () => props$t.search.animation
    },
    // 边框颜色，只要配置了颜色，才会有边框
    borderColor: {
      type: String,
      default: () => props$t.search.borderColor
    },
    // 搜索图标的颜色，默认同输入框字体颜色
    searchIconColor: {
      type: String,
      default: () => props$t.search.searchIconColor
    },
    // 搜索图标的大小
    searchIconSize: {
      type: [Number, String],
      default: () => props$t.search.searchIconSize
    },
    // 输入框字体颜色
    color: {
      type: String,
      default: () => props$t.search.color
    },
    // placeholder的颜色
    placeholderColor: {
      type: String,
      default: () => props$t.search.placeholderColor
    },
    // 左边输入框的图标，可以为uView图标名称或图片路径
    searchIcon: {
      type: String,
      default: () => props$t.search.searchIcon
    },
    // 组件与其他上下左右元素之间的距离，带单位的字符串形式，如"30px"
    margin: {
      type: String,
      default: () => props$t.search.margin
    },
    // 应该是uView-plus版本新增的，用于控制搜索图标的插槽位置
    iconPosition: {
      type: String,
      default: () => props$t.search.iconPosition
    },
    // 输入框最大能输入的长度，-1为不限制长度
    maxlength: {
      type: [String, Number],
      default: () => props$t.search.maxlength
    },
    // 输入框高度，单位px
    height: {
      type: [String, Number],
      default: () => props$t.search.height
    },
    // 键盘弹起时，是否自动上推页面
    adjustPosition: {
      type: Boolean,
      default: () => props$t.search.adjustPosition
    },
    // 键盘收起时，是否自动失去焦点
    autoBlur: {
      type: Boolean,
      default: () => props$t.search.autoBlur
    },
    // 输入框的样式，对象形式
    inputStyle: {
      type: Object,
      default: () => props$t.search.inputStyle
    },
    // 右侧控件的样式，对象形式
    actionStyle: {
      type: Object,
      default: () => props$t.search.actionStyle
    },
    // 自定义样式，对象形式
    customStyle: {
      type: Object,
      default: () => props$t.search.customStyle
    }
  }
});
const props$i = defineMixin({
  props: {
    ...
    show: {
      type: Boolean,
      default: () => props$t.loadingIcon.show
    },
    // 颜色
    color: {
      type: String,
      default: () => props$t.loadingIcon.color
    },
    // 提示文字颜色
    textColor: {
      type: String,
      default: () => props$t.loadingIcon.textColor
    },
    // 文字和图标是否垂直排列
    vertical: {
      type: Boolean,
      default: () => props$t.loadingIcon.vertical
    },
    // 模式选择，circle-圆形，spinner-花朵形，semicircle-半圆形
    mode: {
      type: String,
      default: () => props$t.loadingIcon.mode
    },
    // 图标大小，单位默认px
    size: {
      type: [String, Number],
      default: () => props$t.loadingIcon.size
    },
    // 文字大小
    textSize: {
      type: [String, Number],
      default: () => props$t.loadingIcon.textSize
    },
    // 文字内容
    text: {
      type: [String, Number],
      default: () => props$t.loadingIcon.text
    },
    // 动画模式
    timingFunction: {
      type: String,
      default: () => props$t.loadingIcon.timingFunction
    },
    // 动画执行周期时间
    duration: {
      type: [String, Number],
      default: () => props$t.loadingIcon.duration
    },
    // mode=circle时的暗边颜色
    inactiveColor: {
      type: String,
      default: () => props$t.loadingIcon.inactiveColor
    }
  }
});
const props$h = defineMixin({
  props: {
    ...
    icon: {
      type: String,
      default: () => props$t.empty.icon
    },
    // 提示文字
    text: {
      type: String,
      default: () => props$t.empty.text
    },
    // 文字颜色
    textColor: {
      type: String,
      default: () => props$t.empty.textColor
    },
    // 文字大小
    textSize: {
      type: [String, Number],
      default: () => props$t.empty.textSize
    },
    // 图标的颜色
    iconColor: {
      type: String,
      default: () => props$t.empty.iconColor
    },
    // 图标的大小
    iconSize: {
      type: [String, Number],
      default: () => props$t.empty.iconSize
    },
    // 选择预置的图标类型
    mode: {
      type: String,
      default: () => props$t.empty.mode
    },
    //  图标宽度，单位px
    width: {
      type: [String, Number],
      default: () => props$t.empty.width
    },
    // 图标高度，单位px
    height: {
      type: [String, Number],
      default: () => props$t.empty.height
    },
    // 是否显示组件
    show: {
      type: Boolean,
      default: () => props$t.empty.show
    },
    // 组件距离上一个元素之间的距离，默认px单位
    marginTop: {
      type: [String, Number],
      default: () => props$t.empty.marginTop
    }
  }
});
const props$g = defineMixin({
  props: {
    ...
    duration: {
      type: Number,
      default: () => props$t.tabs.duration
    },
    // tabs标签数组
    list: {
      type: Array,
      default: () => props$t.tabs.list
    },
    // 滑块颜色
    lineColor: {
      type: String,
      default: () => props$t.tabs.lineColor
    },
    // 菜单选择中时的样式
    activeStyle: {
      type: [String, Object],
      default: () => props$t.tabs.activeStyle
    },
    // 菜单非选中时的样式
    inactiveStyle: {
      type: [String, Object],
      default: () => props$t.tabs.inactiveStyle
    },
    // 滑块长度
    lineWidth: {
      type: [String, Number],
      default: () => props$t.tabs.lineWidth
    },
    // 滑块高度
    lineHeight: {
      type: [String, Number],
      default: () => props$t.tabs.lineHeight
    },
    // 滑块背景显示大小，当滑块背景设置为图片时使用
    lineBgSize: {
      type: String,
      default: () => props$t.tabs.lineBgSize
    },
    // 菜单item的样式
    itemStyle: {
      type: [String, Object],
      default: () => props$t.tabs.itemStyle
    },
    // 菜单是否可滚动
    scrollable: {
      type: Boolean,
      default: () => props$t.tabs.scrollable
    },
    // 当前选中标签的索引
    current: {
      type: [Number, String],
      default: () => props$t.tabs.current
    },
    // 默认读取的键名
    keyName: {
      type: String,
      default: () => props$t.tabs.keyName
    },
    // 左侧图标样式
    iconStyle: {
      type: [String, Object],
      default: () => props$t.tabs.iconStyle
    }
  }
});
const props$f = defineMixin({
  props: {
    ...
    status: {
      type: String,
      default: () => props$t.loadmore.status
    },
    // 组件背景色
    bgColor: {
      type: String,
      default: () => props$t.loadmore.bgColor
    },
    // 是否显示加载中的图标
    icon: {
      type: Boolean,
      default: () => props$t.loadmore.icon
    },
    // 字体大小
    fontSize: {
      type: [String, Number],
      default: () => props$t.loadmore.fontSize
    },
    // 图标大小
    iconSize: {
      type: [String, Number],
      default: () => props$t.loadmore.iconSize
    },
    // 字体颜色
    color: {
      type: String,
      default: () => props$t.loadmore.color
    },
    // 加载中状态的图标，spinner-花朵状图标，circle-圆圈状，semicircle-半圆
    loadingIcon: {
      type: String,
      default: () => props$t.loadmore.loadingIcon
    },
    // 加载前的提示语
    loadmoreText: {
      type: String,
      default: () => props$t.loadmore.loadmoreText
    },
    // 加载中提示语
    loadingText: {
      type: String,
      default: () => props$t.loadmore.loadingText
    },
    // 没有更多的提示语
    nomoreText: {
      type: String,
      default: () => props$t.loadmore.nomoreText
    },
    // 在“没有更多”状态下，是否显示粗点
    isDot: {
      type: Boolean,
      default: () => props$t.loadmore.isDot
    },
    // 加载中图标的颜色
    iconColor: {
      type: String,
      default: () => props$t.loadmore.iconColor
    },
    // 上边距
    marginTop: {
      type: [String, Number],
      default: () => props$t.loadmore.marginTop
    },
    // 下边距
    marginBottom: {
      type: [String, Number],
      default: () => props$t.loadmore.marginBottom
    },
    // 高度，单位px
    height: {
      type: [String, Number],
      default: () => props$t.loadmore.height
    },
    // 是否显示左边分割线
    line: {
      type: Boolean,
      default: () => props$t.loadmore.line
    },
    // 线条颜色
    lineColor: {
      type: String,
      default: () => props$t.loadmore.lineColor
    },
    // 是否虚线，true-虚线，false-实线
    dashed: {
      type: Boolean,
      default: () => props$t.loadmore.dashed
    }
  }
});
const props$e = defineMixin({
  props: {
    ...
    type: {
      type: String,
      default: () => props$t.input.type
    },
    // 如果 textarea 是在一个 position:fixed 的区域，需要显示指定属性 fixed 为 true，
    // 兼容性：微信小程序、百度小程序、字节跳动小程序、QQ小程序
    fixed: {
      type: Boolean,
      default: () => props$t.input.fixed
    },
    // 是否禁用输入框
    disabled: {
      type: Boolean,
      default: () => props$t.input.disabled
    },
    // 禁用状态时的背景色
    disabledColor: {
      type: String,
      default: () => props$t.input.disabledColor
    },
    // 是否显示清除控件
    clearable: {
      type: Boolean,
    ...
    password: {
      type: Boolean,
      default: () => props$t.input.password
    },
    // 最大输入长度，设置为 -1 的时候不限制最大长度
    maxlength: {
      type: [String, Number],
      default: () => props$t.input.maxlength
    },
    // 	输入框为空时的占位符
    placeholder: {
      type: String,
      default: () => props$t.input.placeholder
    },
    // 指定placeholder的样式类，注意页面或组件的style中写了scoped时，需要在类名前写/deep/
    placeholderClass: {
      type: String,
      default: () => props$t.input.placeholderClass
    },
    // 指定placeholder的样式
    placeholderStyle: {
      type: [String, Object],
      default: () => props$t.input.placeholderStyle
    },
    // 是否显示输入字数统计，只在 type ="text"或type ="textarea"时有效
    showWordLimit: {
      type: Boolean,
      default: () => props$t.input.showWordLimit
    },
    ...
    confirmType: {
      type: String,
      default: () => props$t.input.confirmType
    },
    // 点击键盘右下角按钮时是否保持键盘不收起，H5无效
    confirmHold: {
      type: Boolean,
      default: () => props$t.input.confirmHold
    },
    // focus时，点击页面的时候不收起键盘，微信小程序有效
    holdKeyboard: {
      type: Boolean,
      default: () => props$t.input.holdKeyboard
    },
    // 自动获取焦点
    // 在 H5 平台能否聚焦以及软键盘是否跟随弹出，取决于当前浏览器本身的实现。nvue 页面不支持，需使用组件的 focus()、blur() 方法控制焦点
    focus: {
      type: Boolean,
      default: () => props$t.input.focus
    },
    // 键盘收起时，是否自动失去焦点，目前仅App3.0.0+有效
    autoBlur: {
      type: Boolean,
      default: () => props$t.input.autoBlur
    },
    // 是否去掉 iOS 下的默认内边距，仅微信小程序，且type=textarea时有效
    disableDefaultPadding: {
      type: Boolean,
      default: () => props$t.input.disableDefaultPadding
    },
    // 指定focus时光标的位置
    cursor: {
      type: [String, Number],
      default: () => props$t.input.cursor
    },
    // 输入框聚焦时底部与键盘的距离
    cursorSpacing: {
      type: [String, Number],
      default: () => props$t.input.cursorSpacing
    },
    // 光标起始位置，自动聚集时有效，需与selection-end搭配使用
    selectionStart: {
      type: [String, Number],
      default: () => props$t.input.selectionStart
    },
    // 光标结束位置，自动聚集时有效，需与selection-start搭配使用
    selectionEnd: {
      type: [String, Number],
      default: () => props$t.input.selectionEnd
    },
    // 键盘弹起时，是否自动上推页面
    adjustPosition: {
      type: Boolean,
      default: () => props$t.input.adjustPosition
    },
    // 输入框内容对齐方式，可选值为：left|center|right
    inputAlign: {
      type: String,
      default: () => props$t.input.inputAlign
    },
    // 输入框字体的大小
    fontSize: {
      type: [String, Number],
      default: () => props$t.input.fontSize
    },
    // 输入框字体颜色
    color: {
      type: String,
      default: () => props$t.input.color
    },
    // 输入框前置图标
    prefixIcon: {
      type: String,
      default: () => props$t.input.prefixIcon
    },
    // 前置图标样式，对象或字符串
    prefixIconStyle: {
      type: [String, Object],
      default: () => props$t.input.prefixIconStyle
    },
    // 输入框后置图标
    suffixIcon: {
      type: String,
      default: () => props$t.input.suffixIcon
    },
    // 后置图标样式，对象或字符串
    suffixIconStyle: {
      type: [String, Object],
      default: () => props$t.input.suffixIconStyle
    },
    // 边框类型，surround-四周边框，bottom-底部边框，none-无边框
    border: {
      type: String,
      default: () => props$t.input.border
    },
    // 是否只读，与disabled不同之处在于disabled会置灰组件，而readonly则不会
    readonly: {
      type: Boolean,
      default: () => props$t.input.readonly
    },
    // 输入框形状，circle-圆形，square-方形
    shape: {
      type: String,
      default: () => props$t.input.shape
    },
    // 用于处理或者过滤输入框内容的方法
    formatter: {
      type: [Function, null],
      default: () => props$t.input.formatter
    },
    // 是否忽略组件内对文本合成系统事件的处理
    ...
    cursorColor: {
      type: String,
      default: () => props$t.input.cursorColor
    },
    // 密码类型可见性切换
    passwordVisibilityToggle: {
      type: Boolean,
      default: () => props$t.input.passwordVisibilityToggle
    }
  }
});
const props$d = defineMixin({
  props: {
    ...
    label: {
      type: String,
      default: () => props$t.formItem.label
    },
    // 绑定的值
    prop: {
      type: String,
      default: () => props$t.formItem.prop
    },
    // 绑定的规则
    rules: {
      type: Array,
      default: () => props$t.formItem.rules
    },
    // 是否显示表单域的下划线边框
    borderBottom: {
      type: [String, Boolean],
      default: () => props$t.formItem.borderBottom
    },
    // label的位置，left-左边，top-上边
    labelPosition: {
      type: String,
      default: () => props$t.formItem.labelPosition
    },
    // label的宽度，单位px
    labelWidth: {
      type: [String, Number],
      default: () => props$t.formItem.labelWidth
    },
    // 右侧图标
    rightIcon: {
      type: String,
      default: () => props$t.formItem.rightIcon
    },
    // 左侧图标
    leftIcon: {
      type: String,
      default: () => props$t.formItem.leftIcon
    },
    // 是否显示左边的必填星号，只作显示用，具体校验必填的逻辑，请在rules中配置
    required: {
      type: Boolean,
      default: () => props$t.formItem.required
    },
    leftIconStyle: {
      type: [String, Object],
      default: () => props$t.formItem.leftIconStyle
    }
  }
});
const props$c = defineMixin({
  props: {
    ...
    model: {
      type: Object,
      default: () => props$t.form.model
    },
    // 验证规则
    rules: {
      type: [Object, Function, Array],
      default: () => props$t.form.rules
    },
    // 有错误时的提示方式，message-提示信息，toast-进行toast提示
    // border-bottom-下边框呈现红色，none-无提示
    errorType: {
      type: String,
      default: () => props$t.form.errorType
    },
    // 是否显示表单域的下划线边框
    borderBottom: {
      type: Boolean,
      default: () => props$t.form.borderBottom
    },
    // label的位置，left-左边，top-上边
    labelPosition: {
      type: String,
      default: () => props$t.form.labelPosition
    },
    // label的宽度，单位px
    labelWidth: {
      type: [String, Number],
      default: () => props$t.form.labelWidth
    },
    // lable字体的对齐方式
    labelAlign: {
      type: String,
      default: () => props$t.form.labelAlign
    },
    // lable的样式，对象形式
    labelStyle: {
      type: Object,
      default: () => props$t.form.labelStyle
    }
  }
});
...
const props$b = defineMixin({
  props: {
    ...
    value: {
      type: [String, Number],
      default: () => props$t.textarea.value
    },
    // 输入框的内容
    modelValue: {
      type: [String, Number],
    ...
    placeholder: {
      type: [String, Number],
      default: () => props$t.textarea.placeholder
    },
    // 指定placeholder的样式类，注意页面或组件的style中写了scoped时，需要在类名前写/deep/
    placeholderClass: {
      type: String,
    ...
    height: {
      type: [String, Number],
      default: () => props$t.textarea.height
    },
    // 设置键盘右下角按钮的文字，仅微信小程序，App-vue和H5有效
    confirmType: {
      type: String,
      default: () => props$t.textarea.confirmType
    },
    // 是否禁用
    disabled: {
      type: Boolean,
      default: () => props$t.textarea.disabled
    },
    // 是否显示统计字数
    count: {
      type: Boolean,
      default: () => props$t.textarea.count
    },
    // 是否自动获取焦点，nvue不支持，H5取决于浏览器的实现
    focus: {
      type: Boolean,
      default: () => props$t.textarea.focus
    },
    // 是否自动增加高度
    autoHeight: {
      type: Boolean,
      default: () => props$t.textarea.autoHeight
    },
    // 如果textarea是在一个position:fixed的区域，需要显示指定属性fixed为true
    fixed: {
      type: Boolean,
      default: () => props$t.textarea.fixed
    },
    // 指定光标与键盘的距离
    cursorSpacing: {
      type: Number,
      default: () => props$t.textarea.cursorSpacing
    },
    // 指定focus时的光标位置
    cursor: {
      type: [String, Number],
      default: () => props$t.textarea.cursor
    },
    // 是否显示键盘上方带有”完成“按钮那一栏，
    showConfirmBar: {
      type: Boolean,
      default: () => props$t.textarea.showConfirmBar
    },
    // 光标起始位置，自动聚焦时有效，需与selection-end搭配使用
    selectionStart: {
      type: Number,
      default: () => props$t.textarea.selectionStart
    },
    // 光标结束位置，自动聚焦时有效，需与selection-start搭配使用
    selectionEnd: {
      type: Number,
      default: () => props$t.textarea.selectionEnd
    },
    // 键盘弹起时，是否自动上推页面
    adjustPosition: {
      type: Boolean,
      default: () => props$t.textarea.adjustPosition
    },
    // 是否去掉 iOS 下的默认内边距，只微信小程序有效
    disableDefaultPadding: {
      type: Boolean,
      default: () => props$t.textarea.disableDefaultPadding
    },
    // focus时，点击页面的时候不收起键盘，只微信小程序有效
    holdKeyboard: {
      type: Boolean,
      default: () => props$t.textarea.holdKeyboard
    },
    // 最大输入长度，设置为 -1 的时候不限制最大长度
    maxlength: {
      type: [String, Number],
      default: () => props$t.textarea.maxlength
    },
    // 边框类型，surround-四周边框，bottom-底部边框
    border: {
      type: String,
      default: () => props$t.textarea.border
    },
    // 用于处理或者过滤输入框内容的方法
    formatter: {
      type: [Function, null],
      default: () => props$t.textarea.formatter
    },
    // 是否忽略组件内对文本合成系统事件的处理
    ignoreCompositionEvent: {
      type: Boolean,
    ...
    switch (accept) {
      ...
      case "file":
        ...
        if (extension.length && extension.length > 0) {
          params2.extension = extension;
        }
        wx$1.chooseMessageFile(params2);
        break;
      default:
...
const props$a = defineMixin({
  props: {
    ...
    accept: {
      type: String,
      default: () => props$t.upload.accept
    },
    extension: {
      type: Array,
      default: () => props$t.upload.extension
    },
    // 	图片或视频拾取模式，当accept为image类型时设置capture可选额外camera可以直接调起摄像头
    capture: {
      type: [String, Array],
      default: () => props$t.upload.capture
    },
    // 当accept为video时生效，是否压缩视频，默认为true
    compressed: {
      type: Boolean,
      default: () => props$t.upload.compressed
    },
    // 当accept为video时生效，可选值为back或front
    camera: {
      type: String,
      default: () => props$t.upload.camera
    },
    // 当accept为video时生效，拍摄视频最长拍摄时间，单位秒
    maxDuration: {
      type: Number,
      default: () => props$t.upload.maxDuration
    },
    // 上传区域的图标，只能内置图标
    uploadIcon: {
      type: String,
      default: () => props$t.upload.uploadIcon
    },
    // 上传区域的图标的颜色，默认
    uploadIconColor: {
      type: String,
      default: () => props$t.upload.uploadIconColor
    },
    // 是否开启文件读取前事件
    useBeforeRead: {
      type: Boolean,
      default: () => props$t.upload.useBeforeRead
    },
    // 读取后的处理函数
    afterRead: {
      type: Function,
    ...
    previewFullImage: {
      type: Boolean,
      default: () => props$t.upload.previewFullImage
    },
    // 最大上传数量
    maxCount: {
      type: [String, Number],
      default: () => props$t.upload.maxCount
    },
    // 是否启用
    disabled: {
      type: Boolean,
      default: () => props$t.upload.disabled
    },
    // 预览上传的图片时的裁剪模式，和image组件mode属性一致
    imageMode: {
      type: String,
      default: () => props$t.upload.imageMode
    },
    // 标识符，可以在回调函数的第二项参数中获取
    name: {
      type: String,
      default: () => props$t.upload.name
    },
    // 所选的图片的尺寸, 可选值为original compressed
    sizeType: {
      type: Array,
      default: () => props$t.upload.sizeType
    },
    // 是否开启图片多选，部分安卓机型不支持
    multiple: {
      type: Boolean,
      default: () => props$t.upload.multiple
    },
    // 是否展示删除按钮
    deletable: {
      type: Boolean,
      default: () => props$t.upload.deletable
    },
    // 文件大小限制，单位为byte
    maxSize: {
      type: [String, Number],
      default: () => props$t.upload.maxSize
    },
    // 显示已上传的文件列表
    fileList: {
      type: Array,
      default: () => props$t.upload.fileList
    },
    // 上传区域的提示文字
    uploadText: {
      type: String,
      default: () => props$t.upload.uploadText
    },
    // 内部预览图片区域和选择图片按钮的区域宽度
    width: {
      type: [String, Number],
      default: () => props$t.upload.width
    },
    // 内部预览图片区域和选择图片按钮的区域高度
    height: {
      type: [String, Number],
      default: () => props$t.upload.height
    },
    // 是否在上传完成后展示预览图
    previewImage: {
      type: Boolean,
      default: () => props$t.upload.previewImage
    },
    // 是否自动删除
    autoDelete: {
      type: Boolean,
      default: () => props$t.upload.autoDelete
    },
    // 是否自动上传需要传递action指定地址
    autoUpload: {
      type: Boolean,
      default: () => props$t.upload.autoUpload
    },
    // 自动上传接口地址
    autoUploadApi: {
      type: String,
      default: () => props$t.upload.autoUploadApi
    },
    // 自动上传驱动，local/oss/cos/kodo
    autoUploadDriver: {
      type: String,
      default: () => props$t.upload.autoUploadDriver
    },
    // 自动上传授权接口，比如oss的签名接口。
    autoUploadAuthUrl: {
      type: String,
      default: () => props$t.upload.autoUploadAuthUrl
    },
    // 自动上传携带的header
    autoUploadHeader: {
      type: Object,
      default: () => {
        return props$t.upload.autoUploadHeader;
      }
    },
    // 本地计算视频封面
    getVideoThumb: {
      type: Boolean,
      default: () => props$t.upload.getVideoThumb
    },
    // 自定义自动上传后处理
    customAfterAutoUpload: {
      type: Boolean,
      default: () => props$t.upload.customAfterAutoUpload
    },
    videoPreviewObjectFit: {
      type: String,
      default: () => props$t.upload.videoPreviewObjectFit
    }
  }
});
const props$9 = defineMixin({
  props: {
    ...
    inputBorder: {
      type: String,
      default: () => props$t.input.inputBorder
    },
    disabled: {
      type: Boolean,
      default: () => props$t.input.disabled
    ...
    show: {
      type: Boolean,
      default: () => props$t.datetimePicker.show
    },
    // 弹出的方向，可选值为 top bottom right left center
    popupMode: {
      type: String,
      default: () => props$t.picker.popupMode
    },
    // 是否展示顶部的操作栏
    showToolbar: {
      type: Boolean,
      default: () => props$t.datetimePicker.showToolbar
    },
    // 工具栏右侧内容
    toolbarRightSlot: {
      type: Boolean,
    ...
    modelValue: {
      type: [String, Number],
      default: () => props$t.datetimePicker.value
    },
    // 顶部标题
    title: {
      type: String,
      default: () => props$t.datetimePicker.title
    },
    // 展示格式，mode=date为日期选择，mode=time为时间选择，mode=year-month为年月选择，mode=datetime为日期时间选择
    mode: {
      type: String,
      default: () => props$t.datetimePicker.mode
    },
    // 可选的最大时间
    maxDate: {
      type: Number,
      // 最大默认值为后10年
      default: () => props$t.datetimePicker.maxDate
    },
    // 可选的最小时间
    minDate: {
      type: Number,
      // 最小默认值为前10年
      default: () => props$t.datetimePicker.minDate
    },
    // 可选的最小小时，仅mode=time有效
    minHour: {
      type: Number,
      default: () => props$t.datetimePicker.minHour
    },
    // 可选的最大小时，仅mode=time有效
    maxHour: {
      type: Number,
      default: () => props$t.datetimePicker.maxHour
    },
    // 可选的最小分钟，仅mode=time有效
    minMinute: {
      type: Number,
      default: () => props$t.datetimePicker.minMinute
    },
    // 可选的最大分钟，仅mode=time有效
    maxMinute: {
      type: Number,
      default: () => props$t.datetimePicker.maxMinute
    },
    // 选项过滤函数
    filter: {
      type: [Function, null],
      default: () => props$t.datetimePicker.filter
    },
    // 选项格式化函数
    formatter: {
      type: [Function, null],
      default: () => props$t.datetimePicker.formatter
    },
    // 是否显示加载中状态
    loading: {
      type: Boolean,
      default: () => props$t.datetimePicker.loading
    },
    // 各列中，单个选项的高度
    itemHeight: {
      type: [String, Number],
      default: () => props$t.datetimePicker.itemHeight
    },
    // 取消按钮的文字
    cancelText: {
      type: String,
      default: () => props$t.datetimePicker.cancelText
    },
    // 确认按钮的文字
    confirmText: {
      type: String,
      default: () => props$t.datetimePicker.confirmText
    },
    // 取消按钮的颜色
    cancelColor: {
      type: String,
      default: () => props$t.datetimePicker.cancelColor
    },
    // 确认按钮的颜色
    confirmColor: {
      type: String,
      default: () => props$t.datetimePicker.confirmColor
    },
    // 每列中可见选项的数量
    visibleItemCount: {
      type: [String, Number],
      default: () => props$t.datetimePicker.visibleItemCount
    },
    // 是否允许点击遮罩关闭选择器
    closeOnClickOverlay: {
      type: Boolean,
      default: () => props$t.datetimePicker.closeOnClickOverlay
    },
    // 各列的默认索引
    defaultIndex: {
      type: Array,
      default: () => props$t.datetimePicker.defaultIndex
    },
    // 是否页面内展示
    pageInline: {
      type: Boolean,
      default: () => props$t.datetimePicker.pageInline
    },
    // 蒙层样式样式
    maskClass: {
      type: String,
...
const props$8 = defineMixin({
  props: {
    ...
    show: {
      type: Boolean,
      default: () => props$t.popup.show
    },
    // 是否显示遮罩
    overlay: {
      type: Boolean,
      default: () => props$t.popup.overlay
    },
    // 弹出的方向，可选值为 top bottom right left center
    mode: {
      type: String,
      default: () => props$t.popup.mode
    },
    // 动画时长，单位ms
    duration: {
      type: [String, Number],
      default: () => props$t.popup.duration
    },
    // 是否显示关闭图标
    closeable: {
      type: Boolean,
      default: () => props$t.popup.closeable
    },
    // 自定义遮罩的样式
    overlayStyle: {
      type: [Object, String],
      default: () => props$t.popup.overlayStyle
    },
    // 点击遮罩是否关闭弹窗
    closeOnClickOverlay: {
      type: Boolean,
      default: () => props$t.popup.closeOnClickOverlay
    },
    // 层级
    zIndex: {
      type: [String, Number],
      default: () => props$t.popup.zIndex
    },
    // 是否为iPhoneX留出底部安全距离
    safeAreaInsetBottom: {
      type: Boolean,
      default: () => props$t.popup.safeAreaInsetBottom
    },
    // 是否留出顶部安全距离（状态栏高度）
    safeAreaInsetTop: {
      type: Boolean,
      default: () => props$t.popup.safeAreaInsetTop
    },
    // 自定义关闭图标位置，top-left为左上角，top-right为右上角，bottom-left为左下角，bottom-right为右下角
    closeIconPos: {
      type: String,
      default: () => props$t.popup.closeIconPos
    },
    // 是否显示圆角
    round: {
      type: [Boolean, String, Number],
      default: () => props$t.popup.round
    },
    // mode=center，也即中部弹出时，是否使用缩放模式
    zoom: {
      type: Boolean,
      default: () => props$t.popup.zoom
    },
    // 弹窗背景色，设置为transparent可去除白色背景
    bgColor: {
      type: String,
      default: () => props$t.popup.bgColor
    },
    // 遮罩的透明度，0-1之间
    overlayOpacity: {
      type: [Number, String],
      default: () => props$t.popup.overlayOpacity
    },
    // 是否页面内展示
    pageInline: {
      type: Boolean,
      default: () => props$t.popup.pageInline
    },
    // 是否页开启手势滑动
    touchable: {
      type: Boolean,
      default: () => props$t.popup.touchable
    },
    // 手势滑动最小高度
    minHeight: {
      type: [String],
      default: () => props$t.popup.minHeight
    },
    // 手势滑动最大高度
    maxHeight: {
      type: [String],
      default: () => props$t.popup.maxHeight
    }
  }
});
const props$7 = defineMixin({
  props: {
    ...
    src: {
      type: String,
      default: () => props$t.avatar.src
    },
    // 头像形状，circle-圆形，square-方形
    shape: {
      type: String,
      default: () => props$t.avatar.shape
    },
    // 头像尺寸
    size: {
      type: [String, Number],
      default: () => props$t.avatar.size
    },
    // 裁剪模式
    mode: {
      type: String,
      default: () => props$t.avatar.mode
    },
    // 显示的文字
    text: {
      type: String,
      default: () => props$t.avatar.text
    },
    // 背景色
    bgColor: {
      type: String,
      default: () => props$t.avatar.bgColor
    },
    // 文字颜色
    color: {
      type: String,
      default: () => props$t.avatar.color
    },
    // 文字大小
    fontSize: {
      type: [String, Number],
      default: () => props$t.avatar.fontSize
    },
    // 显示的图标
    icon: {
      type: String,
      default: () => props$t.avatar.icon
    },
    // 显示小程序头像，只对百度，微信，QQ小程序有效
    mpAvatar: {
      type: Boolean,
      default: () => props$t.avatar.mpAvatar
    },
    // 是否使用随机背景色
    randomBgColor: {
      type: Boolean,
      default: () => props$t.avatar.randomBgColor
    },
    // 加载失败的默认头像(组件有内置默认图片)
    defaultUrl: {
      type: String,
      default: () => props$t.avatar.defaultUrl
    },
    ...
    colorIndex: {
      ...
      default: () => props$t.avatar.colorIndex
    },
    // 组件标识符
    name: {
      type: String,
      default: () => props$t.avatar.name
    }
  }
});
const props$6 = defineMixin({
  props: {
    ...
    show: {
      type: Boolean,
      default: () => props$t.transition.show
    },
    // 使用的动画模式
    mode: {
      type: String,
      default: () => props$t.transition.mode
    },
    // 动画的执行时间，单位ms
    duration: {
      type: [String, Number],
      default: () => props$t.transition.duration
    },
    // 使用的动画过渡函数
    timingFunction: {
      type: String,
      default: () => props$t.transition.timingFunction
    }
  }
});
...
const props$5 = defineMixin({
  props: {
    color: {
      type: String,
      default: () => props$t.line.color
    },
    // 长度，竖向时表现为高度，横向时表现为长度，可以为百分比，带px单位的值等
    length: {
      type: [String, Number],
      default: () => props$t.line.length
    },
    // 线条方向，col-竖向，row-横向
    direction: {
      type: String,
      default: () => props$t.line.direction
    },
    // 是否显示细边框
    hairline: {
      type: Boolean,
      default: () => props$t.line.hairline
    },
    // 线条与上下左右元素的间距，字符串形式，如"30px"、"20px 30px"
    margin: {
      type: [String, Number],
      default: () => props$t.line.margin
    },
    // 是否虚线，true-虚线，false-实线
    dashed: {
      type: Boolean,
      default: () => props$t.line.dashed
    }
  }
});
const props$4 = defineMixin({
  props: {
    bgColor: {
      type: String,
      default: () => props$t.statusBar.bgColor
    },
    // 状态栏获取得高度
    height: {
      type: Number,
      default: () => props$t.statusBar.height
    }
  }
});
const props$3 = defineMixin({
  props: {
    ...
    disabled: {
      type: Boolean,
      default: () => props$t.picker.disabled
    },
    disabledColor: {
      type: String,
      default: () => props$t.picker.disabledColor
    },
    placeholder: {
      type: String,
      default: () => props$t.picker.placeholder
    },
    // 是否展示picker弹窗
    show: {
      type: Boolean,
      default: () => props$t.picker.show
    },
    // 弹出的方向，可选值为 top bottom right left center
    popupMode: {
      type: String,
    ...
    showToolbar: {
      type: Boolean,
      default: () => props$t.picker.showToolbar
    },
    // 顶部标题
    title: {
      type: String,
      default: () => props$t.picker.title
    },
    // 对象数组，设置每一列的数据
    columns: {
      type: Array,
      default: () => props$t.picker.columns
    },
    // 是否显示加载中状态
    loading: {
      type: Boolean,
      default: () => props$t.picker.loading
    },
    // 各列中，单个选项的高度
    itemHeight: {
      type: [String, Number],
      default: () => props$t.picker.itemHeight
    },
    // 取消按钮的文字
    cancelText: {
      type: String,
      default: () => props$t.picker.cancelText
    },
    // 确认按钮的文字
    confirmText: {
      type: String,
      default: () => props$t.picker.confirmText
    },
    // 取消按钮的颜色
    cancelColor: {
      type: String,
      default: () => props$t.picker.cancelColor
    },
    // 确认按钮的颜色
    confirmColor: {
      type: String,
      default: () => props$t.picker.confirmColor
    },
    // 每列中可见选项的数量
    visibleItemCount: {
      type: [String, Number],
      default: () => props$t.picker.visibleItemCount
    },
    // 选项对象中，需要展示的属性键名
    keyName: {
      type: String,
      default: () => props$t.picker.keyName
    },
    // 选项对象中，需要获取的属性值键名
    valueName: {
      type: String,
      default: () => props$t.picker.valueName
    },
    // 是否允许点击遮罩关闭选择器
    closeOnClickOverlay: {
      type: Boolean,
      default: () => props$t.picker.closeOnClickOverlay
    },
    // 各列的默认索引
    defaultIndex: {
      type: Array,
      default: () => props$t.picker.defaultIndex
    },
    // 是否在手指松开时立即触发 change 事件。若不开启则会在滚动动画结束后触发 change 事件，只在微信2.21.1及以上有效
    immediateChange: {
      type: Boolean,
      default: () => props$t.picker.immediateChange
    },
    // 工具栏右侧插槽是否开启
    toolbarRightSlot: {
      type: Boolean,
    ...
    zIndex: {
      type: [String, Number],
      default: () => props$t.picker.zIndex
    },
    // 弹窗背景色，设置为transparent可去除白色背景
    bgColor: {
      type: String,
      default: () => props$t.picker.bgColor
    },
    // 是否显示圆角
    round: {
      type: [Boolean, String, Number],
      default: () => props$t.picker.round
    },
    // 动画时长，单位ms
    duration: {
      type: [String, Number],
      default: () => props$t.picker.duration
    },
    // 遮罩的透明度，0-1之间
    overlayOpacity: {
      type: [Number, String],
      default: () => props$t.picker.overlayOpacity
    },
    // 是否页面内展示
    pageInline: {
      type: Boolean,
      default: () => props$t.picker.pageInline
    },
    // 蒙层样式样式
    maskClass: {
      type: String,
...
const props$2 = defineMixin({
  props: {
    ...
    show: {
      type: Boolean,
      default: () => props$t.overlay.show
    },
    // 层级z-index
    zIndex: {
      type: [String, Number],
      default: () => props$t.overlay.zIndex
    },
    // 遮罩的过渡时间，单位为ms
    duration: {
      type: [String, Number],
      default: () => props$t.overlay.duration
    },
    // 不透明度值，当做rgba的第四个参数
    opacity: {
      type: [String, Number],
      default: () => props$t.overlay.opacity
    }
  }
});
...
const props = defineMixin({
  props: {
    ...
    show: {
      type: Boolean,
      default: () => props$t.toolbar.show
    },
    // 取消按钮的文字
    cancelText: {
      type: String,
      default: () => props$t.toolbar.cancelText
    },
    // 确认按钮的文字
    confirmText: {
      type: String,
      default: () => props$t.toolbar.confirmText
    },
    // 取消按钮的颜色
    cancelColor: {
      type: String,
      default: () => props$t.toolbar.cancelColor
    },
    // 确认按钮的颜色
    confirmColor: {
      type: String,
      default: () => props$t.toolbar.confirmColor
    },
    // 标题文字
    title: {
      type: String,
      default: () => props$t.toolbar.title
    },
    // 开启右侧插槽
    rightSlot: {
      type: Boolean,
...
exports.props$13 = props$t;
exports.props$14 = props$f;
exports.props$15 = props$e;
exports.props$16 = props$d;
exports.props$17 = props$c;
exports.props$18 = props$b;
exports.props$19 = props$a;
exports.props$2 = props$q;
exports.props$20 = props$9;
exports.props$21 = props$8;
exports.props$22 = props$7;
exports.props$23 = props$6;
exports.props$24 = props$5;
exports.props$25 = props$4;
exports.props$26 = props$3;
exports.props$27 = props$2;
exports.props$28 = props$1;
exports.props$29 = props;
